      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            duration: 0.6,
            delay: 0.2
          }} className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">Análise de Dados Descomplicada para Marketplaces</motion.h1>
          ...
          <div className="relative w-full max-w-xl mx-auto lg:mx-0">
            ...
            delay: 0.4
              ...
              <div className="relative bg-white rounded-xl shadow-lg overflow-hidden">
                <img src="/lovable-uploads/dfa81c44-1063-45b7-8144-fa5c9675e87e.png" alt="Dashboard Anye - Visão geral dos indicadores do seu negócio" className="w-full h-auto object-cover" />
              </div>
              
              <motion.div className="absolute -z-10 -top-5 -right-5 w-24 h-24 rounded-full bg-accent-orange/30 blur-xl" animate={{
              scale: [1, 1.2, 1]
            }} transition={{
              duration: 4,
              repeat: Infinity,
              ...
              <motion.div className="absolute -z-10 -bottom-8 -left-8 w-32 h-32 rounded-full bg-primary-blue/30 blur-xl" animate={{
              scale: [1, 1.3, 1]
            }} transition={{
              duration: 5,
              repeat: Infinity,
        ...
        delay: 0.8
          ...
          <div className="flex flex-wrap justify-center items-center gap-8">
            ...
            delay: 1 + index * 0.2
                ...
                <img src={brand.src} alt={brand.name} className="h-8 md:h-10 w-auto object-contain opacity-70 hover:opacity-100 transition-opacity duration-300" />
              </motion.div>)}
          </div>
        </motion.div>
      </div>
